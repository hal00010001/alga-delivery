...
public class Delivery extends AbstractAggregateRoot<Delivery> {
    ...
    public UUID addItem(String name, int quantity, Delivery delivery){
        Item item = Item.brandNew(name, quantity, delivery);
        items.add(item);
    ...
    public void changeItemQuantity(UUID itemId, int quantity){
        Item item = this.getItems().stream().filter(i -> i.getId().equals(itemId))
    ...
    public void markAsDelivered(){
        ...
        super.registerEvent(new DeliveryFulfilledEvent(this.getFullfilledAt(), this.getId()));
    }
