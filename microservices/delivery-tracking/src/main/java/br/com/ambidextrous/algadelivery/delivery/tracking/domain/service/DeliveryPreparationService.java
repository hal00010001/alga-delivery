...
import br.com.ambidextrous.algadelivery.delivery.tracking.api.model.ContactPointInput;
import br.com.ambidextrous.algadelivery.delivery.tracking.api.model.DeliveryInput;
import br.com.ambidextrous.algadelivery.delivery.tracking.api.model.ItemInput;
...
//        Duration expectedDeliveryTime = Duration.ofHours(3);
        ...
        for (ItemInput itemInput : input.getItems()){
            delivery.addItem(itemInput.getName(), itemInput.getQuantity(), delivery);
        }
